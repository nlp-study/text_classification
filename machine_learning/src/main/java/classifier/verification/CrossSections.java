...
public class CrossSections {
	...
	int size;
	private int[] stones;
	List<VerificationID> verificationIDs = new ArrayList<VerificationID>();
	...
	public List<VerificationID> getVerificationIDs() {
	...
	public void calculateVerification()
	{
		for(int i=0;i<stones.length;++i)
		{
			if(i < stones.length-1)
			{
				...
				VerificationID verificationID = new VerificationID(all,test);
